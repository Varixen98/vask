<form action="{{route("store.address")}}" method="POST" class="w-full flex flex-col items-center gap-5">
    ...
    <div class="flex gap-20 w-[85%]">
        ...
        <input type="text" name="postal_code" id="postal_code" autocomplete="off" class="w-1/2 p-1 border border-gray-300 rounded-md shadow-md">
    </div>
    ...
    <div class="flex gap-20 w-[85%]">
        ...
        <textarea name="street_address" id="street_address" cols="30" rows="5" class="w-1/2 p-1 border border-gray-300 rounded-md shadow-md"></textarea>
    </div>
